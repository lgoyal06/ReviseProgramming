...
public final class ReciprocalArraySum {
    ...
    private static class ReciprocalArraySumTask extends RecursiveAction {
        ...
        protected void compute() {
            if (endIndexExclusive - startIndexInclusive < 40) {
     ...
     * Join framework. You may assuparArraySumme that the length of the input array is
     * evenly divisible by 2.
     *
     * @param input Input array
     * @return The sum of the reciprocals of the array input
     */
    public static double parArraySum(final double[] input) {
     ...
     * @return The sum of the reciprocals of the array input
     */
    public static double parManyTaskArraySum(final double[] input,
                                             final int numTasks) {
        double sum = 0;
